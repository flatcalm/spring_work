            ...
            <div class="col-lg-6 col-md-9 col-sm-12 join-form">
                ...
                <form action="${pageContext.request.contextPath}/user/join" method="post" name="joinForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input name="addrZipNum" type="text" class="form-control" id="addrZipNum" placeholder="우편번호" readonly>
                            <div class="input-group-addon">
...
<%@ include file="../include/footer.jsp" %>
    ...
    <script>
        ...
        document.getElementById('idCheckBtn').onclick = function() {
            ...
            if(!idFlag) { // 정규표현식을 만족하지 않으면 중복 검사를 실행하지 않음.
            ...
            */
            ...
            .then(res => {
                ...
                // 요청이 완료 된 후 then()의 매개 값으로 응답에 관련된 
                // 함수를 콜백 방식으로 전달합니다.
                // 함수의 매개 변수를 선언하면 해당 매개 변수로 응답에 관련된 
                    ...
                    fetch('${pageContext.request.contextPath}/user/mailCheck?email=' + email)
                        .then(res => res.text())
                            .then(data => {
                                ...
                                // 비활성된 인증번호 입력창을 활성화
                                // setAttribute('disabled', false)가 적용이 되지 않아서 remove 사용했는데 disabled로 직접 주면 가능.
                                ...
                                alert('인증 번호가 전송되었습니다. 확인 후 입력란에 정확히 입력해주세요.');
                            }); // 비동기 끝.
                }; // 인증번호 이벤트 끝.
